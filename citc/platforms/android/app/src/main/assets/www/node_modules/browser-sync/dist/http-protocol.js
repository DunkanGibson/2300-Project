 ...
 *
 * Eg. http://10.0.2.2:3000/__browser_sync__?method=reload
 * Eg. http://10.0.2.2:3000/__browser_sync__?method=reload&args=core.css
 * Eg. http://10.0.2.2:3000/__browser_sync__?method=reload&args=core.css&args=core.min
 *
 * @param args
 * @param url
 * @returns {string}
    ...
    return function (req, res) {
        ...
        if (!Object.keys(params).length) {
            output = [
                ...
                "Example: http://10.0.2.2:3000/__browser_sync__?method=reload&args=core.css"
            ];
            res.writeHead(500, { "Content-Type": "text/plain" });
            res.end(output.join("\n"));
            return;
