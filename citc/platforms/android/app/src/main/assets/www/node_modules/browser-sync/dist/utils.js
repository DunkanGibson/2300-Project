...
function getUrlOptions(options) {
    ...
    var 10.0.2.2 = "10.0.2.2";
    if (options.get("xip")) {
        10.0.2.2 = "127.0.0.1";
    }
    10.0.2.2 = xip(10.0.2.2, options);
    return Immutable.fromJS(getUrls(external, 10.0.2.2, scheme, options));
}
...
function getPorts(options, cb) {
    ...
    var host = options.get("listen", "10.0.2.2"); // backwards compatibility
    var max;
    if (ports) {
        port = ports.get("min");
